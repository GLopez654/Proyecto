document.addEventListener('DOMContentLoaded', () => {
    ...
    if (main && !document.querySelector('.brochure-download')) {
        ...
        const brochureSection = document.createElement('section');
        brochureSection.className = 'brochure-section';
        brochureSection.setAttribute('aria-label', 'Descarga de brochure');
        brochureSection.style.textAlign = 'center';
        brochureSection.style.margin = '3.5rem auto';
        brochureSection.style.padding = '0 1rem';
        brochureSection.append(brochureDownload);

        // Inserción limpia asegurando que quede antes del footer y no dentro de él
        if (siteFooter) {
            siteFooter.before(brochureSection);
        } else {
            main.append(brochureSection);
        }
    }
